...
public class LevelOnePlayerTests {
    ...
    public void Init() {
        ...
        playerPrefab = (GameObject)UnityEngine.Object.Instantiate(Resources.Load("Test/player_1"));
        levelPrefab = (GameObject)UnityEngine.Object.Instantiate(Resources.Load("Test/level_1"));
    }
