...
public class LevelThreePlayerTests {
    ...
    public void Init()
    {
        ...
        playerPrefab = (GameObject)UnityEngine.Object.Instantiate(Resources.Load("Test/player_3"));
        levelPrefab = (GameObject)UnityEngine.Object.Instantiate(Resources.Load("Test/level_3"));
    }
